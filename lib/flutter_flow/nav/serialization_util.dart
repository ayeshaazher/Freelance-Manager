  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetAllTasksRow:
            return GetAllTasksRow(data);
          case GetAllTasksbasedOnGroupRow:
            return GetAllTasksbasedOnGroupRow(data);
          case GetAllTasksbasedOnStatusRow:
            return GetAllTasksbasedOnStatusRow(data);
          case GetAllSingleGroupTasksRow:
            return GetAllSingleGroupTasksRow(data);
          default:
            return null;
        }
